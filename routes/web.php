...
Route::get('diagnosis-baik', function () {
    return view('diagnosis-baik');
});

Route::get('diagnosis-buruk', function () {
    return view('diagnosis-buruk');
});

Route::get('/hasil/diagnosis-buruk', function () {
    return view('hasil.diagnosis-buruk');
})->name('hasil.diagnosis-buruk');
